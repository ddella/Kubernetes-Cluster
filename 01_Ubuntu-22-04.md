...
To install the latest Linux kernel package, which is available in the [Ubuntu Kernel repository](https://kernel.ubuntu.com), use the command:
```sh
...
```sh
sudo apt --purge remove linux-image-5.15.0-76-generic
```
